defmodule DbProjWeb.EntryControllerTest do
  use DbProjWeb.ConnCase

  alias DbProj.Entries

  @create_attrs %{additionalNotes: "some additionalNotes", continuousDrugTesting: true, drugTesting: true}
  ...
  describe "update entry" do
    ...
    test "redirects when data is valid", %{conn: conn, entry: entry} do
      ...
      assert html_response(conn, 200) =~ "some updated additionalNotes"
    end
